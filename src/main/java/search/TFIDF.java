...
public class TFIDF {
    ...
    //frequency of term occurrence in a single document
    ...
    //for a given document create a map with term:frequency pairs
    ...
    for given term and each document get InverseDocumentFrequency based on the term-frequencies in all documents
    documentResults -- documentName:Map<term:frequency>
    */
...
//    for all terms get their inverseDocumentFrequency
    ...
    //how important is a document?
    //for a given document get DocumentScore based on terms' inverseDocumentFrequencies
    ...
    //get documentScores for all documents
...
//    add document to the document list with the same score
